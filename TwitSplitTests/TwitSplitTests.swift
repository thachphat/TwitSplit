...
class TwitSplitTests: XCTestCase {
    ...
    func testSplitMessageGreaterThan9Splits() {
        ...
        XCTAssert(String.splitMessage(message: _10SplitsMessage) == _10Splits, "Split message with 10 splits, 45 characters each and last one is 10 characters")
        ...
        XCTAssert(String.splitMessage(message: _99SplitsMessage) == _99Splits, "Split message with 99 splits")
        ...
        XCTAssert(String.splitMessage(message: _102SplitsMessage) == _102Splits, "Split message with > 100 splits")
    }
